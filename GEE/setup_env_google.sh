...
#-----------------------------------------------------------------------------------------
# Script information
script_name='GOOGLE ENVIRONMENT - PYTHON3 LIBRARIES FOR PACKAGE - CONDA'
...
fp_env_tag_default='google_libraries'
...
if [ -f $fp_env_file_requirements ] ; then
	...
	conda create --yes --name $fp_env_folder_libraries numpy scipy pandas matplotlib rasterio geopandas xarray netCDF4 pip python jupyterlab ipykernel
