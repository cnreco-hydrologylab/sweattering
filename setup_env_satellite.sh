...
#-----------------------------------------------------------------------------------------
# Script information
script_name='SATELLITE ENVIRONMENT - PYTHON3 LIBRARIES FOR PACKAGE - CONDA'
script_version="1.6.4"
script_date='2023/05/22'

# Define working directory
fp_cwd='/home/martina/Documents/codes_repietra' # no slash at the end!
...
fp_env_file_requirements_default='requirements_%ENV_TAG.yml'
...
if [ -f $fp_env_file_requirements ] ; then
	...
	source activate $fp_env_folder_libraries
	conda install -c conda-forge python=3.9 numpy pandas matplotlib scipy pip jupyter jupyterlab ipykernel openpyxl

	echo " ======> [1/2] CONDA-DEFAULT CHANNEL INSTALLATION ... DONE"
	
	echo " ======> [2/2] PYTHON-PIP INSTALLATION ... "
	
	# install conda incompatible packagesd
	pip install hydroeval pyswarms
	
	# pyeto installation from source
	cd Modules/pyeto/
